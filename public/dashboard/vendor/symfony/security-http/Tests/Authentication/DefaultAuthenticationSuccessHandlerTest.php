...
class DefaultAuthenticationSuccessHandlerTest extends TestCase
{
    ...
    public function getRequestRedirections()
    {
        ...
        $session->expects($this->once())->method('get')->with('_security.admin.target_path')->will($this->returnValue('/admin/dash'));
        ...
        return [
            ...
            'target path as referer' => [
                Request::create('/', 'GET', [], [], [], ['HTTP_REFERER' => 'http://localhost/dash']),
                ['use_referer' => true],
                '/dash',
            ],
