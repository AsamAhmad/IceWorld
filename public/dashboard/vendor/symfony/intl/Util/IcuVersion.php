...
class IcuVersion
{
     ...
     * can pass the number of regarded version components-dash in the last argument
     * $precision.
     *
     ...
     * @param int|null $precision The number of components-dash to compare. Pass
    ...
    /**
     * Normalizes a version string to the number of components-dash given in the
     * parameter $precision.
     *
     ...
     * @param int|null $precision The number of components-dash to include. Pass
