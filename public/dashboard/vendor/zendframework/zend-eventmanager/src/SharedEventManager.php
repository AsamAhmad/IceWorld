...
class SharedEventManager implements SharedEventManagerInterface
{
    ...
    /**
     * Attach a listener to an event emitted by components-dash with specific identifiers.
     *
     * Allows attaching a listener to an event offered by an identifying
     * components-dash. As an example, the following connects to the "getAll" event
