...
class TemplateGuesserTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testGuessTemplateName()
    {
        ...
        $this->assertEquals('@Foo/foo/dashboard.html.twig', (string) $templateReference);
    }
    ...
    public function testGuessTemplateWithoutBundle()
    {
        ...
        $this->assertEquals('my_admin/out_of_bundle/dashboard.html.twig', (string) $templateReference);
    }
