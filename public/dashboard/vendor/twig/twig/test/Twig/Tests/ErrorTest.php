...
EOHTML
        ...
        try {
            ...
            $this->assertEquals('Variable "foo" does not exist in "dashboard.html" at line 3.', $e->getMessage());
            $this->assertEquals(3, $e->getTemplateLine());
            $this->assertEquals('dashboard.html', $e->getSourceContext()->getName());
        }
    }
...
EOHTML
        ...
        try {
            ...
            $this->assertEquals('An exception has been thrown during the rendering of a template ("Runtime error...") in "dashboard.html" at line 3.', $e->getMessage());
            $this->assertEquals(3, $e->getTemplateLine());
            $this->assertEquals('dashboard.html', $e->getSourceContext()->getName());
        }
    }
