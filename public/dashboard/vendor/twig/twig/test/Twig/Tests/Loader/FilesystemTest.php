...
class Twig_Tests_Loader_FilesystemTest extends \PHPUnit\Framework\TestCase
{
    public function testGetSourceContext()
    {
        ...
        $this->assertEquals('errors/dashboard.html', $loader->getSourceContext('errors/dashboard.html')->getName());
        $this->assertEquals(realpath($path.'/errors/dashboard.html'), realpath($loader->getSourceContext('errors/dashboard.html')->getPath()));
    }
    ...
    public function testPaths($basePath, $cacheKey, $rootPath)
    {
        ...
        $this->assertEquals("path (final)\n", $loader->getSourceContext('dashboard.html')->getCode());
        $this->assertEquals("path (final)\n", $loader->getSourceContext('@__main__/dashboard.html')->getCode());
        $this->assertEquals("named path (final)\n", $loader->getSourceContext('@named/dashboard.html')->getCode());
    }
    ...
    public function testFindTemplateWithCache()
    {
        ...
        // prime the cache for dashboard.html in the named namespace
        $namedSource = $loader->getSourceContext('@named/dashboard.html')->getCode();
        $this->assertEquals("named path\n", $namedSource);

        // get dashboard.html from the main namespace
    ...
    public function testTemplateExistsAlwaysReturnsBool()
    {
        ...
        $this->assertTrue($loader->exists('dashboard.html'));
        $loader->addPath(__DIR__.'/Fixtures/normal', 'foo');
        $this->assertTrue($loader->exists('@foo/dashboard.html'));
    }
}
