...
class Twig_Tests_Loader_ChainTest extends \PHPUnit\Framework\TestCase
{
    public function testGetSourceContext()
    {
        ...
        $loader = new ChainLoader([
            ...
            new ArrayLoader(['errors/dashboard.html' => 'baz']),
        ...
        $this->assertSame('', $loader->getSourceContext('errors/dashboard.html')->getPath());
        $this->assertEquals('baz', $loader->getSourceContext('errors/dashboard.html')->getCode());
