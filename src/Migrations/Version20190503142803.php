 ...
 */
final class Version20190503142803 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE allergenes ADD name VARCHAR(255) NOT NULL, DROP nom');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE allergenes ADD nom VARCHAR(100) NOT NULL COLLATE utf8mb4_unicode_ci, DROP name');
    }
}
